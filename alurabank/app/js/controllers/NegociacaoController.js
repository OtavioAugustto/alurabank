        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    const negociacao = new index_2.Negociacao(data, parseInt(this._inputQuantidade.val()), parseFloat(this._inputaValor.val()));
            ...
            ], NegociacaoController.prototype, "_inputaValor", void 0);
